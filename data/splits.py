...
val_train_low=['scene-1067', 'scene-1068', 'scene-1070', 'scene-1072', 'scene-1066', 'scene-1069', 'scene-0770', 'scene-0797', 'scene-0271', 'scene-1065', 'scene-0777', 'scene-0775',
               'scene-1071', 'scene-0771', 'scene-0913', 'scene-1064', 'scene-0015', 'scene-0927', 'scene-0272', 'scene-0273', 'scene-0012', 'scene-1063', 'scene-0929', 'scene-0800',
               'scene-0914', 'scene-0925', 'scene-0919', 'scene-0799', 'scene-0626', 'scene-0907', 'scene-0798', 'scene-0931', 'scene-0930', 'scene-0908', 'scene-0014', 'scene-0911',
               'scene-0794', 'scene-0038',
               'scene-0016', 'scene-0003', 'scene-0924', 'scene-0802', 'scene-0796', 'scene-0018', 'scene-1073', 'scene-0274', 'scene-0275', 'scene-0013', 'scene-0636', 'scene-0637']
...
val_val = [
     ...
     'scene-0552', 'scene-0553', 'scene-0554', 'scene-0555', 'scene-0556', 'scene-0557', 'scene-0558', 'scene-0559',
     'scene-0560', 'scene-0561', 'scene-0562', 'scene-0563', 'scene-0564', 'scene-0565', 'scene-0625', 'scene-0626',
     'scene-0627', 'scene-0629',  'scene-0632', 'scene-0633', 'scene-0634', 'scene-0635', 'scene-0636',
     'scene-0637', 'scene-0638', 'scene-0770', 'scene-0771', 'scene-0775', 'scene-0777', 'scene-0778', 'scene-0780',
     'scene-0781', 'scene-0782', 'scene-0783', 'scene-0784', 'scene-0794', 'scene-0795', 'scene-0796', 'scene-0797',
     'scene-0798', 'scene-0799', 'scene-0800',  'scene-0904', 'scene-0905', 'scene-0906', 'scene-0907',
     'scene-0916', 'scene-0917', 'scene-0919', 'scene-0920', 'scene-0921', 'scene-0922', 'scene-0923', 'scene-0924',
     'scene-0963', 'scene-0966', 'scene-0967', 'scene-0968', 'scene-0969', 'scene-0971', 'scene-0972', 'scene-1059',
     'scene-1068', 'scene-1069', 'scene-1070', 'scene-1071', 'scene-1072', 'scene-1073'
]
...
new_mini_train = ['scene-0061', 'scene-0553', 'scene-0655', 'scene-0757', 'scene-0796', 'scene-1077', 'scene-1094',
                  'scene-1100']
new_mini_val = ['scene-0103', 'scene-0916']
...
mini_test=['scene-0077','scene-0113', 'scene-0114', 'scene-0115','scene-1042']
...
mini_val_train = ['scene-0103']
mini_val_val= ['scene-0916']
singapore_train = \
...
def create_splits_scenes(verbose: bool = False) -> Dict[str, List[str]]:
    ...
    scene_splits = {'train': train, 'val': val,
                    ...
                    'val_train':val_train,'val_val':val_val,
                    'test':test,'mini_test':mini_test,
                    'new_train': new_train, 'new_val': new_val,
                    'new_mini_train': mini_train, 'new_mini_val': mini_val,
                    'mini_val_train': mini_val_train, 'mini_val_val': mini_val_val,
