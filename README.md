...
### Data
This work not only requires the nuScenes dataset, but also utilizes the synthetic data generated by world models, namely [PerDiff](https://github.com/CVL-UESTC/PerLDiff), [MagicDrive](https://github.com/CVL-UESTC/PerLDiff) and BEVControl.
